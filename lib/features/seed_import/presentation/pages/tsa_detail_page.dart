...
class TsaDetailPage extends StatelessWidget {
  ...
  Future<void> _createShop(BuildContext context, String tsaId) async {
                  ...
                  children: [
                    ...
                    if (picked != null) ...[
                      ...
                      Align(
                        ...
                        child: Text(
                          'Location: ${picked!.latitude.toStringAsFixed(6)}, ${picked!.longitude.toStringAsFixed(6)}',
    ...
    final ref = shopsCol.doc(shopId);
    final existing = await ref.get();
    if (existing.exists) {
      Get.snackbar(
        'Shop already exists',
        'A shop with code "${result.code}" already exists.',
        snackPosition: SnackPosition.BOTTOM,
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => _createShop(context, tsaId),
